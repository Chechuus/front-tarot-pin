...
import imagen from "../Utilidades/Imagines/Servicios/servicio.jpg";

export const Servicios = () => {
    return (
        <section className="columna_color2">
            <div className="container text center" id="accordion" >
                <div className="row" >
                    ...
                    <div className="col col2">
                        <img className="img-thumbnail float-end" src={imagen} alt="" />
                    </div>
                </div>
            </div>
        </section>
